// #ifndef RAYLIB_FIXED_H
// #define RAYLIB_FIXED_H

// // Avoid conflicts with Windows API
// #define WIN32_LEAN_AND_MEAN // Exclude unnecessary Windows headers
// #define NOMINMAX            // Avoid min/max macro conflicts
// #define NOGDI               // Exclude GDI functions (conflicts with Rectangle)
// #define NOUSER              // Exclude user functions (conflicts with CloseWindow)
// #define NOIME               // Exclude input method editor (IME) functions

// // Rename conflicting functions
// #define CloseWindow Raylib_CloseWindow
// #define ShowCursor Raylib_ShowCursor
// #define LoadImageA Raylib_LoadImageA
// #define DrawTextA Raylib_DrawTextA
// #define DrawTextExA Raylib_DrawTextExA
// #define Rectangle Raylib_Rectangle

// #endif // RAYLIB_FIXED_H

#define WIN32_LEAN_AND_MEAN // Exclude unnecessary Windows headers
#define NOMINMAX            // Prevent min/max macro conflicts
#define NOGDI               // Prevent GDI conflicts (Rectangle)
#define NOUSER              // Prevent CloseWindow conflict
#define NOIME               // Prevent IME functions conflict
/**********************************************************************************************
 *
